...
const primaryKeys = {
  ...
  student_fee_assignments: "assignment_id",
  fee_invoices: "invoice_id",
  fee_collections: "collection_id",
  fee_waivers: "waiver_id",
  ...
  institution_subject_settings: "setting_id",
  exam_types: "exam_type_id",
  grading_scales: "grading_scale_id",
  grading_scale_details: "grade_detail_id",
  exams: "exam_id",
  exam_subjects: "exam_subject_id",
  mark_components: "component_id",
  exam_subject_components: "exam_subject_component_id",
  exam_candidates: "candidate_id",
  exam_seating_assignments: "seating_assignment_id",
  exam_marks: "mark_id",
  student_results: "result_id",
  student_result_details: "result_detail_id",
  document_templates: "template_id",
  issued_documents: "issued_document_id",
};
