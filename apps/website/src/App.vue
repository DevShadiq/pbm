    ...
    <div class="bg-bdGreen-900 text-white text-sm py-1.5 relative z-50">
        <div class="max-w-7xl mx-auto px-4 flex flex-wrap items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-3">
                ...
                <a :href="adminLoginUrl" class="ml-2 inline-flex items-center gap-1.5 bg-white/10 hover:bg-white/20 px-3 py-1 rounded-full text-xs font-bold transition-colors">
