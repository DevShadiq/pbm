...
},
{
  ...
  meta: { permission: "exam.management", action: "view", examSection: "dashboard" },
},
{
  path: "exams/setup",
  name: "ExamSetup",
  component: () => import("../views/exam/ExamManagementView.vue"),
  meta: { permission: "exam.management", action: "view", examSection: "setup" },
},
{
  path: "exams/class-subjects",
  name: "ClassSubjectSetup",
  component: () => import("../views/exam/ClassSubjectSetupView.vue"),
  meta: { permission: "exam.management", action: "view" },
},
{ path: "exams/subjects", name: "SubjectEntry", component: () => import("../views/exam/SubjectEntryView.vue"), meta: { permission: "subject.management", action: "view" } },
{
  path: "exams/routine",
  name: "ExamRoutine",
...
},
{
  ...
  name: "ExamCandidates",
  component: () => import("../views/exam/ExamManagementView.vue"),
  meta: { permission: "exam.management", action: "view", examSection: "candidates" },
},
{
  path: "exams/marks",
  name: "ExamMarks",
  component: () => import("../views/exam/ExamManagementView.vue"),
  meta: { permission: "exam.management", action: "view", examSection: "marks" },
},
{
  path: "exams/results",
  name: "ExamResults",
  component: () => import("../views/exam/ExamManagementView.vue"),
  meta: { permission: "exam.management", action: "view", examSection: "results" },
},
{
  path: "exams/documents",
  name: "ExamDocuments",
  component: () => import("../views/exam/ExamManagementView.vue"),
  meta: { permission: "exam.management", action: "view", examSection: "documents" },
},
{
  path: "exams/reports",
  name: "ExamReports",
  component: () => import("../views/exam/ExamManagementView.vue"),
  meta: { permission: "exam.management", action: "view", examSection: "reports" },
},
